...
+ 查看各主机的 `IP` 地址
  ...
  **攻击者主机 （kali)：**
  ...
  ![attacker网络地址](./img/attacker网络地址.png)

  

  **XP靶机1：**

  ![xp1网络地址](./img/xp1网络地址.png)

  

  **XP靶机2：**

  ![xp2网络地址](./img/xp2网络地址.png)

  

  **kali靶机：**

  ![Victim-Kali网络地址](./img/Victim-Kali网络地址.png)

  

  **Debian靶机：**

  ![Victim-Debian-2网络地址](./img/Victim-Debian-2网络地址.png)
...
- [x] 所有节点均可以访问互联网
  ...
  **攻击者访问百度：**
  ...
  ![攻击者访问百度](./img/攻击者访问百度.png)

  **xp1访问百度：**

  ![XP1访问百度](./img/XP1访问百度.png)

  **xp2访问百度：**

  ![XP2访问百度](./img/XP2访问百度.png)

  **kali访问百度：**

  ![kali访问百度](./img/kali访问百度.png)

  **debian访问百度：**

  ![debian访问百度](./img/debian访问百度.png)

  **网关访问百度：**

  ![网关访问百度](./img/网关访问百度.png)
